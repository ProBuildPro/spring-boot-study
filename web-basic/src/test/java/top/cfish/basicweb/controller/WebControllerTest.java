...
public class WebControllerTest extends BasicWebApplicationTests
{
    ...
    {
        MockHttpServletRequestBuilder builder = MockMvcRequestBuilders.post("/setUserForm").param("name", "isisiwish").param("age", "18").param("pass", "password");
    ...
    public void setUserJson() throws Exception
    {
        ...
        MockHttpServletRequestBuilder builder = MockMvcRequestBuilders.post("/setUserJson").contentType(MediaType.APPLICATION_JSON).content(json);
    ...
    {
        MockHttpServletRequestBuilder builder = MockMvcRequestBuilders.post("/saveValidUser").param("name", "isisiwish").param("age", "16").param("pass", "password");
